...
public class UserLogSinkToMySQL extends RichSinkFunction<UserLog> {
    ...
    public void invoke(UserLog value, Context context) throws Exception {
        ...
        String sqlLog = ((ClientPreparedStatement)ps).asSql();
    ...
    private static Connection getConnection() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db-flk?allowMultiQueries=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8",
                    "root", "123456");
        } catch (Exception e) {
